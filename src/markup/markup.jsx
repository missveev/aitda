			...
			<>
				<BrowserRouter basename={'/react/'}>
					<Switch>
						...
						<Route path='/accredit' exact component={accredit} />
						<Route path='/corporate-structure' exact component={corporateStructure} />
						...
						{/*Degree */}
						<Route path='/courses-search' exact component={coursesearch} />
