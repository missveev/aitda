...
const content = [
	{ 
		thumb: eventPic2,
		title: "Class Begins For Fall Semester",
		text: "Our institution will be fully opened for the fall semester. This will be our very first physical class.",
	},
	{ 
		thumb: eventPic3,
		title: "International Conference on Journalism",
		text: "Africanvoice International Training and Development Academy is to hold the “1st International Conference on Journalism” on 20-22 April 2021 in cooperation with University of Lagos.",
	},
	{ 
		thumb: eventPic4,
									...
									<div className="event-bx">
										<div className="action-box">
											...
											<div className="event-time">
												<div className="event-date">01</div>
										...
										<div className="info-bx d-flex">
											<div className="event-info">
												<ul className="media-post">
													<li><Link to="/events-details"><i className="fa fa-clock-o"></i> 9:00am</Link></li>
													<li><Link to="/events-details"><i className="fa fa-map-marker"></i> Ado-Ekiti, Ekiti</Link></li>
												</ul>
