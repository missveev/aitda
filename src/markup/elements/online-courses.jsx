								...
								<div className="col-md-4 col-sm-6 col-6">
									<div className="cours-search-bx m-b30">
										<div className="icon-box">
											<h3><i className="ti-user"></i><Count counter={100}/></h3>
										</div>
										<span className="cours-search-text">Over 100 students</span>
									</div>
								</div>
								<div className="col-md-4 col-sm-6 col-6">
									<div className="cours-search-bx m-b30">
										...
										<span className="cours-search-text">Learn Anything Online.</span>
									</div>
								</div>
								<div className="col-md-4 col-sm-12 col-12">
									<div className="cours-search-bx m-b30">
										<div className="icon-box">
											<h3><i className="ti-book"></i><Count counter={300}/></h3>
										</div>
										<span className="cours-search-text">300 Courses.</span>
									</div>
								</div>
							</div>
						</div>
