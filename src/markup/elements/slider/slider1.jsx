						...
						<div className="slider-content text-white">
							<div className="container">
								<div className="content-inner">
									<h6 className="sub-title">Welcome To AITDA </h6>
									<h2 className="title">Master the Skills to Drive your Career.</h2>
									<p>African-voice International Training and Development Academy, is an International multi-disciplinary
										Institution offering consulting services and training in Journalism and New Media, Entrepreneurship! It
										also offers advisory services, educational events, printing and Publishing of Journals on Leadership,
										Development and Governance.</p>
